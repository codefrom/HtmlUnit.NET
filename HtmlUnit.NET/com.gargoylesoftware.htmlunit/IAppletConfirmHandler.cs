...
namespace HtmlUnit.com.gargoylesoftware.htmlunit
{
    ...
    /// @author Ronald Brill
    /// </summary>
    public interface IAppletConfirmHandler
    {
        /// <summary>
        /// Handles a confirm for the specified page.
        /// </summary>
        /// <param name="applet">the applet the browser likes to start</param>
        /// <returns>true if starting is allowed</returns>
        public bool Confirm(HtmlApplet applet);
    }
}
