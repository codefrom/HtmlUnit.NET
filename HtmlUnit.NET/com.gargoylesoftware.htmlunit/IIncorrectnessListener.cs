...
namespace HtmlUnit.com.gargoylesoftware.htmlunit
{
    ...
    /// </summary>
    public class IIncorrectnessListener
    {
        /// <summary>
        /// Called to notify an incorrectness.
        /// </summary>
        /// <param name="message">the explanation of the incorrectness</param>
        /// <param name="origin">the object that encountered this incorrectness</param>
